#region 1
cat > file1 # Ստեղծում է ֆայլ file1. և սպասում է ստեղնաշարի մուտքագրմանը, մինչև կմուտքագրվի Ctrl+D: Մուտքագրված տեքստը կգրվի file1-ում:
cat file1 # Ցույց է տալիս file1-ի պարունակությունը:
cat < file1 # Ցույց է տալիս file1-ի պարունակությունը:
#endregion
